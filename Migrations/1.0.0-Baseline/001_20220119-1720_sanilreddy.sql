-- <Migration ID="c3f12291-f4ff-4aa3-b9b8-b76197742f22" TransactionHandling="Custom" />
GO

DECLARE @associate bit
SELECT @associate = CASE SERVERPROPERTY('EngineEdition') WHEN 5 THEN 1 ELSE 0 END
IF @associate = 0 EXEC sp_executesql N'SELECT @count = COUNT(*) FROM master.dbo.syslogins WHERE loginname = N''admin''', N'@count bit OUT', @associate OUT
IF @associate = 1
BEGIN
    PRINT N'Creating user [admin] and mapping to the login [admin]'
    IF DATABASE_PRINCIPAL_ID(N'admin') IS NULL
CREATE USER [admin] FOR LOGIN [admin]
END
ELSE
BEGIN
    PRINT N'Creating user [admin] without login'
    IF DATABASE_PRINCIPAL_ID(N'admin') IS NULL
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.fulltext_catalogs WHERE name = N'AW2016FullTextCatalog')
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.xml_schema_collections WHERE name = N'HRResumeSchemaCollection' AND schema_id = SCHEMA_ID(N'HumanResources'))
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.xml_schema_collections WHERE name = N'AdditionalContactInfoSchemaCollection' AND schema_id = SCHEMA_ID(N'Person'))
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.xml_schema_collections WHERE name = N'IndividualSurveySchemaCollection' AND schema_id = SCHEMA_ID(N'Person'))
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.xml_schema_collections WHERE name = N'ManuInstructionsSchemaCollection' AND schema_id = SCHEMA_ID(N'Production'))
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.xml_schema_collections WHERE name = N'ProductDescriptionSchemaCollection' AND schema_id = SCHEMA_ID(N'Production'))
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.xml_schema_collections WHERE name = N'StoreSurveySchemaCollection' AND schema_id = SCHEMA_ID(N'Sales'))
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[ufnLeadingZeros]') AND (type = 'IF' OR type = 'FN' OR type = 'TF' OR type = 'FT' OR type = 'FS'))
EXEC sp_executesql N'
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[ufnGetAccountingStartDate]') AND (type = 'IF' OR type = 'FN' OR type = 'TF' OR type = 'FT' OR type = 'FS'))
EXEC sp_executesql N'
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[ufnGetAccountingEndDate]') AND (type = 'IF' OR type = 'FN' OR type = 'TF' OR type = 'FT' OR type = 'FS'))
EXEC sp_executesql N'
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.objects WHERE object_id = OBJECT_ID(N'[Production].[UQ__Document__F73921F7751EE450]', 'UQ') AND parent_object_id = OBJECT_ID(N'[Production].[Document]', 'U'))
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.fulltext_indexes JOIN sys.fulltext_catalogs ON sys.fulltext_indexes.fulltext_catalog_id = sys.fulltext_catalogs.fulltext_catalog_id WHERE  name = N'AW2016FullTextCatalog' AND object_id = OBJECT_ID(N'[Production].[Document]', 'U'))
...
PRINT N'Adding full text indexing to tables'
GO
IF NOT EXISTS (SELECT 1 FROM sys.fulltext_indexes JOIN sys.fulltext_catalogs ON sys.fulltext_indexes.fulltext_catalog_id = sys.fulltext_catalogs.fulltext_catalog_id WHERE  name = N'AW2016FullTextCatalog' AND object_id = OBJECT_ID(N'[HumanResources].[JobCandidate]', 'U'))
...
PRINT N'Adding full text indexing to tables'
GO
IF NOT EXISTS (SELECT 1 FROM sys.fulltext_indexes JOIN sys.fulltext_catalogs ON sys.fulltext_indexes.fulltext_catalog_id = sys.fulltext_catalogs.fulltext_catalog_id WHERE  name = N'AW2016FullTextCatalog' AND object_id = OBJECT_ID(N'[Production].[ProductReview]', 'U'))
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[ufnGetContactInformation]') AND (type = 'IF' OR type = 'FN' OR type = 'TF' OR type = 'FT' OR type = 'FS'))
EXEC sp_executesql N'
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[ufnGetProductDealerPrice]') AND (type = 'IF' OR type = 'FN' OR type = 'TF' OR type = 'FT' OR type = 'FS'))
EXEC sp_executesql N'
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[ufnGetProductListPrice]') AND (type = 'IF' OR type = 'FN' OR type = 'TF' OR type = 'FT' OR type = 'FS'))
EXEC sp_executesql N'
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[ufnGetProductStandardCost]') AND (type = 'IF' OR type = 'FN' OR type = 'TF' OR type = 'FT' OR type = 'FS'))
EXEC sp_executesql N'
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[ufnGetStock]') AND (type = 'IF' OR type = 'FN' OR type = 'TF' OR type = 'FT' OR type = 'FS'))
EXEC sp_executesql N'
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[ufnGetDocumentStatusText]') AND (type = 'IF' OR type = 'FN' OR type = 'TF' OR type = 'FT' OR type = 'FS'))
EXEC sp_executesql N'
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[ufnGetPurchaseOrderStatusText]') AND (type = 'IF' OR type = 'FN' OR type = 'TF' OR type = 'FT' OR type = 'FS'))
EXEC sp_executesql N'
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[ufnGetSalesOrderStatusText]') AND (type = 'IF' OR type = 'FN' OR type = 'TF' OR type = 'FT' OR type = 'FS'))
EXEC sp_executesql N'
...
GO
IF OBJECT_ID(N'[dbo].[AddressType]', 'U') IS NULL
...
GO
IF NOT EXISTS (SELECT 1 FROM fn_listextendedproperty(N'MS_Description', 'SCHEMA', N'Person', 'TABLE', N'PersonPhone', 'CONSTRAINT', N'DF_PersonPhone_ModifiedDate'))
...
GO
IF NOT EXISTS (SELECT 1 FROM fn_listextendedproperty(N'MS_Description', 'SCHEMA', N'Person', 'TABLE', N'PersonPhone', 'CONSTRAINT', N'FK_PersonPhone_Person_BusinessEntityID'))
...
GO
IF NOT EXISTS (SELECT 1 FROM fn_listextendedproperty(N'MS_Description', 'SCHEMA', N'Person', 'TABLE', N'PersonPhone', 'CONSTRAINT', N'FK_PersonPhone_PhoneNumberType_PhoneNumberTypeID'))
...
GO
IF NOT EXISTS (SELECT 1 FROM fn_listextendedproperty(N'MS_Description', 'SCHEMA', N'Person', 'TABLE', N'PhoneNumberType', 'INDEX', N'PK_PhoneNumberType_PhoneNumberTypeID'))
