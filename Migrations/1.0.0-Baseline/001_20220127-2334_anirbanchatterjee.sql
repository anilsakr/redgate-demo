-- <Migration ID="2c1c3f2d-9c56-497a-955a-781b651f38e6" TransactionHandling="Custom" />
GO
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.objects WHERE object_id = OBJECT_ID(N'[Production].[UQ__Document__F73921F7C5112C2E]', 'UQ') AND parent_object_id = OBJECT_ID(N'[Production].[Document]', 'U'))
